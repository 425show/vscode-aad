...
export class GraphClient extends msRestAzure.AzureServiceClient {
    ...
    constructor(public credentials: any, public tenantID: string, public baseUri = 'https://graph.microsoft.com/') {
        super(credentials, {});
...
class Details {
    ...
    getWithHttpOperationResponse(path: string) {
